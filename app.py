...
<div class="main-header">
    ...
    <p>Tác giả: Hà Thị Chiên - Trường PTDTBT Tiểu học Ngam La - ĐT: 035 7600 827</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hà Thị Chiên - Trường PTDTBT Tiểu học Ngam La - ĐT: 035 7600 827</div>", unsafe_allow_html=True)
